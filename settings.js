...
SESSION_ID: process.env.SESSION_ID === undefined ? '𝐃ᴇᴠɪʟ-𝐓ᴇᴄʜ-𝐌ᴅ=boZU3R7B#lJgpurELbRDH_OjKuypGyyEf17TpXcG_j7QgedON6jE' : process.env.SESSION_ID,
...
ANTI_BAD2: process.env.ANTI_BAD2 === undefined ? "false" : process.env.ANTI_BAD2,
OWNER_REACT: process.env.OWNER_REACT === undefined ? "false" : process.env.OWNER_REACT,
...
ANTI_BOT2: process.env.ANTI_BOT2 === undefined ? "false" : process.env.ANTI_BOT2,
...
LOGO: process.env.LOGO === undefined ? 'https://files.catbox.moe/l5kxmb.jpg' : process.env.LOGO,   
